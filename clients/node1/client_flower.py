import flwr as fl
import torch
from clients.node1.data_loader import get_loaders  # correct import path
from model import SimpleModel  # replace with your actual model file if different

# --------------------------
# Load data for node1
# --------------------------
train_loader, val_loader = get_loaders("clients/node1/data")
